...
const camperaCueroNegra = new Producto("CAMPERA DE CUERO NEGRA", "./assets/cueroNegra.jpg", "Cuero", 5400, "Negro");
const buzoAmarillo = new Producto("BUZO AMARILLO", "./assets/buzoAmarillo.jpg", "Buzo", 3900, "Amarillo");
const sweaterVerde = new Producto("SWEATER VERDE", "./assets/sweaterVerde.jpg", "Sweater", 2500, "Verde");
const anorakAzul = new Producto("ANORAK AZUL", "./assets/campera.jpg", "Anorak", 4000, "Azul");
const hoodieVerde = new Producto("HOODIE VERDE", "./assets/hoodieVerde.jpg", "Hoodie", 3000, "Verde");
...
function productsInit() {
  ...
  const toggle = document.querySelector('.toggle'); 
    ...
    const arrayObjects = [anorakAzul, camperaCueroNegra, buzoAmarillo, sweaterVerde, hoodieVerde];
  ...
  // TIPO
  let hoodieFilter = document.getElementById("hoodie_filter");
  hoodieFilter.addEventListener("click", hoodieFilterClothes);
  let cueroFilter = document.getElementById("cuero_filter");
  cueroFilter.addEventListener("click", cueroFilterClothes);
  let buzoFilter = document.getElementById("buzo_filter");
  buzoFilter.addEventListener("click", buzoFilterClothes);
  let sweaterFilter = document.getElementById("sweater_filter");
  sweaterFilter.addEventListener("click", sweaterFilterClothes);
  let anorakFilter = document.getElementById("anorak_filter");
  anorakFilter.addEventListener("click", anorakFilterClothes);
  ...
  function hoodieFilterClothes() {
    products.innerHTML = ``;
    const filterObjets = arrayObjects.map((element) => {
      if (element.type === hoodieFilter.dataset.tipo) {
        renderProducts(element);
        popUp(element);
      };
    });
  ...
  function cueroFilterClothes() {
    products.innerHTML = ``;
    const filterObjets = arrayObjects.map((element) => {
      if (element.type === cueroFilter.dataset.tipo) {
        renderProducts(element);
        popUp(element);
      };
    });
  ...
  function buzoFilterClothes() {
    products.innerHTML = ``;
    const filterObjets = arrayObjects.map((element) => {
      if (element.type === buzoFilter.dataset.tipo) {
        renderProducts(element);
        popUp(element);
      };
    });
  ...
  function sweaterFilterClothes() {
    products.innerHTML = ``;
    const filterObjets = arrayObjects.map((element) => {
      if (element.type === sweaterFilter.dataset.tipo) {
        renderProducts(element);
        popUp(element);
      };
    });
  ...
  function anorakFilterClothes() {
    products.innerHTML = ``;
    const filterObjets = arrayObjects.map((element) => {
      if (element.type === anorakFilter.dataset.tipo) {
        renderProducts(element);
        popUp(element);
      };
    });
